        ...
        <div className="z-50" id="project">
            ...
            <div className="flex flex-col lm:flex-wrap gap-8 md:gap-6 lm:flex-row items-center lm:items-stretch lm:justify-center">
                {dataPortfolio.map((data) => (
                    <div key={data.id} className="border w-[80vw] sm:w-[70vw] border-[#2c1f31b4] dark:border-[#69707c9d] relative px-6 pt-6 pb-7 rounded-2xl sm:px-[35px] sm:pb-8 lm:w-[37.5vw] lm:px-6 lm:pt-6 lm:pb-7 lx:w-[32.2vw] xl:w-[23.2vw]">
                        ...
                        <div className="flex border-[1.8px] border-black dark:border-white rounded-full w-8 h-8 hover:bg-[#2c1f31] dark:hover:bg-[#0a0a0a9c] absolute right-5 top-4 items-end justify-center sm:right-9 sm:top-6 lm:right-6 lm:top-8">
                            <a href={data.urlGithub} target="_blank">
                                <LucideGithub className="hover:text-orange-200 text-[#2c1f31] dark:text-white"/>
                            </a>
                        </div>
                        ...
                        <div className="w-full mt-5 flex gap-4 items-center justify-center text-[#2c1f31] dark:text-white">
                            {data.technology}
                        </div>
                    </div>
                ))}
